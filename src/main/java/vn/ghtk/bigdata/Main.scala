...
//
//    //    val b  = parser.parseQuery(sql_parser)
//    //    b.asInstanceOf[Project].projectList.addString(new StringBuffer().append(s"cast('IF(('op = d), 'before.type_1, 'after.type_1) as int) AS type_1"))
